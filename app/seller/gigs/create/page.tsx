...
import { useCreateGigs } from '@/api/gigsApi'
...
const Page = () => {
  ...
  const {createGig,isPending} = useCreateGigs()
    ...
    if(category && description && title && features.length
      && price > 0 && shortDesc.length && revision > 0 && time > 0 
        ...
        try{
         ...
         setData({time:0,title:"",description:"",category:"",shortDesc:"",
          feature:"",revision:0,price:0});
          setFiles([]);
          setFeatures([]);
